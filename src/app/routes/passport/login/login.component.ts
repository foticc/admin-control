...
export class UserLoginComponent implements OnDestroy {
  ...
  form = this.fb.nonNullable.group({
    userName: ['admin', [Validators.required, Validators.minLength(3), Validators.maxLength(12)]],
    password: ['123456', [Validators.required, Validators.minLength(3), Validators.maxLength(12)]],
